...
void	ft_rotate_right(v_list *cube)
{
	...
	cube->ray.dirX = cube->ray.dirX * cos(-cube->ray.rotspeed / 2) -
		cube->ray.dirY * sin(-cube->ray.rotspeed / 2);
	cube->ray.dirY = oldDirX * sin(-cube->ray.rotspeed / 2) +
		cube->ray.dirY * cos(-cube->ray.rotspeed / 2);
	cube->ray.planeX = cube->ray.planeX * cos(-cube->ray.rotspeed / 2) -
		cube->ray.planeY * sin(-cube->ray.rotspeed / 2);
	cube->ray.planeY = oldPlaneX * sin(-cube->ray.rotspeed / 2) +
		cube->ray.planeY * cos(-cube->ray.rotspeed / 2);
}
