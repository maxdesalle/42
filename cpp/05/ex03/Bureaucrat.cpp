...
/*   Updated: 2021/10/26 18:31:08 by maxdesall        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				Bureaucrat::signForm(Form &ref)
{
	...
	{
		ref.beSigned(*this);
		std::cout << "A " << _name << " successfully signed a " << ref.getName() << ".";
		std::cout << std::endl;
	}
	catch (Form::Exception &e)
	{
		std::cout << "A " << _name << " unsuccessfully tried to sign a " << ref.getName() << ".";
		std::cout << std::endl;
	}
}
